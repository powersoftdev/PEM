...
import { paymentTypesDetail, PayrollModel } from 'src/app/Model/PayrollModel/payrollModel';
...
@Component({
  ...
  templateUrl: './payrollPaytype.component.html',
  styleUrls: ['./payrollPaytype.component.css']
})
